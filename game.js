...
function is2Count (element, index, array) { //eslint-disable-line
  return element === 2;
}

function is3Count (element, index, array) { //eslint-disable-line
  return element === 3;
}

function is4Count (element, index, array) { //eslint-disable-line
  return element === 4;
}

function is5Count (element, index, array) { //eslint-disable-line
  return element === 5;
}
